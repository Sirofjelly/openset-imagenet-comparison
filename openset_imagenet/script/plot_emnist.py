...
def command_line_options(command_line_arguments=None):
    ...
    """
    parser = argparse.ArgumentParser("EMNIST Plotting", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument(
        "--protocols", "-p",
        type=int,
        choices = (1,2,3),
    ...
    parser.add_argument(
        ...
        default = ('softmax', 'garbage', 'entropic', 'bce'),
    ...
    parser.add_argument(
        ...
        nargs = "+",
        default = ["threshold", "maxlogits", "openmax", "evm", "proser", "binary_ensemble_emnist"],
    ...
    for protocol in args.protocols:
        for loss in args.losses:
            for algorithm in args.algorithms:
                output_directory = pathlib.Path(cfg.output_directory)
